...
class CoolUtil
{
	...
	*/
	public static inline function centerOverlay(object:flixel.FlxObject, base:flixel.FlxObject, axes:flixel.util.FlxAxes = XY):flixel.FlxObject {
	...
	/** Quick Function to Fix Save Files for Flixel 5
		...
		@BeastlyGabi
	**/
	public static function getSavePath(folder:String = 'JustJack'):String {
		@:privateAccess
