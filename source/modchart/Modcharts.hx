...
class Modcharts {
    ...
    public static function loadModchart(modManager:ModManager, songName:String){
        switch (songName.toLowerCase()){
            case 'test':
                modManager.setPercent('reverse', -62.5);
                modManager.setPercent('alpha', 100);

                modManager.queueEase(124, 128, "reverse", 0, "linear", 1);
                modManager.queueEase(124, 128, "alpha", 0, "linear", 1);

                modManager.queueEase(139, 143, "reverse", 0, "linear", 0);
                modManager.queueEase(139, 143, "alpha", 0, "linear", 0);
