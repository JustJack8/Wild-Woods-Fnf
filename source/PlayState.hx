...
class PlayState extends MusicBeatState
{
	...
	public static var STRUM_Y = ClientPrefs.downScroll ? FlxG.height - 150 : 50;
	...
	public var grpNoteSplashes:FlxTypedSpriteGroup<NoteSplash>;
	...
	var phillyGlowParticles:FlxTypedSpriteGroup<PhillyGlow.PhillyGlowParticle>;
	...
	var bgLimo:BGSprite;
	var grpLimoParticles:FlxTypedSpriteGroup<BGSprite>;
	var grpLimoDancers:FlxTypedSpriteGroup<BackgroundDancer>;
	...
	var tankmanRun:FlxTypedSpriteGroup<TankmenBG>;
	var foregroundSprites:FlxTypedSpriteGroup<BGSprite>;
	...
	override public function create()
	{
		...
		grpNoteSplashes = new FlxTypedSpriteGroup<NoteSplash>();
		...
		{
			case 'mae': 
				var bg:BGSprite = new BGSprite('wildWoodsStage/Mae_Stage', -767, -466, 1, 1);
			...
			case 'tank': //Week 7 - Ugh, Guns, Stress
				...
				foregroundSprites = new FlxTypedSpriteGroup<BGSprite>();
		...
		if(ClientPrefs.downScroll && !useModchart) strumLine.y = FlxG.height - 150;
	...
	function eventPushed(event:EventNote)
	{
		switch (event.event)
		{
			...
			case 'Philly Glow':
				...
				phillyGlowParticles = new FlxTypedSpriteGroup<PhillyGlow.PhillyGlowParticle>();
	...
	public function reloadGameOver():Void 
	{
